...
import { Box, Layers, Cpu, Globe, MapPin, Mail, Linkedin, Instagram, ChevronDown } from 'lucide-react';
                ...
                >
                  ...
                  <div style={{ position: 'relative', zIndex: 2 }}>
                      <div style={{ 
                        ...
                        borderRadius: '50px', border: '1px solid rgba(255,255,255,0.1)', marginBottom: '1.5rem',
                        backdropFilter: 'blur(5px)', color: '#60a5fa', fontSize: '0.9rem' 
                      }}>
                        🚀 AR/VR Club GHRCEM
                      </div>
                ...
                <div>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
                    <div style={{ display: 'flex', gap: '1rem', alignItems: 'center' }}>
                      <div style={{ padding: '10px', background: 'rgba(59,130,246,0.1)', borderRadius: '8px' }}><MapPin color="#3b82f6" /></div>
                      <div>
                    ...
                    <div style={{ display: 'flex', gap: '1rem', alignItems: 'center' }}>
                      <div style={{ padding: '10px', background: 'rgba(59,130,246,0.1)', borderRadius: '8px' }}><Mail color="#3b82f6" /></div>
                      <div>
                    ...
                    <div style={{ display: 'flex', gap: '1rem', marginTop: '1rem' }}>
                      <a href="https://linkedin.com" target="_blank" className="btn-outline" style={{ padding: '10px' }}><Linkedin size={20} /></a>
                      <a href="https://instagram.com" target="_blank" className="btn-outline" style={{ padding: '10px' }}><Instagram size={20} /></a>
                    </div>
                  </div>
                </div>
                <ContactForm />
